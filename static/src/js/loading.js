odoo.define('cenoel_backend_theme.Loading', function (require) {
    "use strict";
...
var WebLoading = require('web.Loading');

var _t = core._t;

var Loading = WebLoading.include({
    template: "Loading",
    ...
    on_rpc_event : function(increment) {
        ...
        if (this.count > 0) {
            ...
            this.getParent().$el.addClass('page-loading');
        } else {
            this.count = 0;
            ...
            this.$el.fadeOut();
            this.getParent().$el.removeClass('page-loading');
        }
    }
});
